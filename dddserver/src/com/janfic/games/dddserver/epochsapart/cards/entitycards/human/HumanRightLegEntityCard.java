...
public class HumanRightLegEntityCard extends HumanEntityCard {

    float health;

    public HumanRightLegEntityCard() {
        super("Human Right Leg", 15);
        setFace(Assets.getSingleton().getHumanEntityCards().findRegion("right_leg"));
        setFaceUp(true);
        addImage();
    }
}
