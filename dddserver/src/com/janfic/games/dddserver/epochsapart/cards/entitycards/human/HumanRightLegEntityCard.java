...
public class HumanRightLegEntityCard extends EntityCard {

    float health;

    public HumanRightLegEntityCard() {
        super("Human Right Leg");
        setFace(new TextureRegion(new Texture("cards/entitycards/entity_human_right_leg.png")));
        setFaceUp(true);
